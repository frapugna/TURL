This code was adapted from the original [TURL](https://github.com/sunlab-osu/TURL.git) and includes an adaptation of the `TURL_get_embeddings.py` file taken form the [TURL_embeddings_for_thetis](https://github.com/leventidis/TURL_embeddings_for_thetis.git) repository from @leventidis. To replicate our environment use the `environment.yml` file to create a conda environment. 
